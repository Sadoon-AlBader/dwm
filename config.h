...
static Key keys[] = {
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("sudo cpupower frequency-set --governor conservative") }, 
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("sudo cpupower frequency-set --governor performance") },
